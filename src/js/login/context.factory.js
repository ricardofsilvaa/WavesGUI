(function () {
    ...
    function LoginContextFactory(moduleEvents, applicationEvents, modes) {
        return {
            ...
            showTitleSeedScreen: function ($scope) {
                $scope.$emit(moduleEvents.CHANGE_MODE, modes.TITLE);
            },

            showDescriptionSeedScreen: function ($scope) {
                $scope.$emit(moduleEvents.CHANGE_MODE, modes.DESCRIPTION);
            },
